            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  {Object.keys(variants).includes("silver") &&  <button name="btnColor" value="silver" onClick={changeVariant} className={`border-2 border-gray-300 shadow-xl ml-1 bg-slate-200 rounded-full w-6 h-6 ${color==="yellow"?"outline-slate-500 outline outline-2":"none"}`}></button>}
                  {Object.keys(variants).includes("green") &&  <button name="btnColor" value="green" onClick={changeVariant} className={`border-2 border-gray-300 shadow-xl ml-1 bg-green-400 rounded-full w-6 h-6 ${color==="yellow"?"outline-slate-500 outline outline-2":"none"}`}></button>}
